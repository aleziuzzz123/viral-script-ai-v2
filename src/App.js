...
// --- SVG Icons for the UI (These were missing) ---
                ...
                {session ? (
                    ...
                    <div className="text-center py-20 px-4">
                        ...
                        <div className="max-w-2xl mx-auto">
                            <div className="flex flex-col sm:flex-row gap-2">
                                <input type="text" value={topic} onChange={(e) => setTopic(e.target.value)} placeholder="Enter a topic to get started..." className="w-full bg-gray-800 border border-gray-600 rounded-lg p-4 focus:outline-none focus:ring-2 focus:ring-green-500" />
                                <button onClick={handleGenerate} className="bg-green-500 hover:bg-green-600 text-white font-semibold py-3 px-6 rounded-lg whitespace-nowrap">Generate Free</button>
                            </div>
                        </div>
                    </div>
                )}
